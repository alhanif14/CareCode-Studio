...
import { FaCheckCircle } from "react-icons/fa"; // Ikon untuk list
...
export default function Pricing() {
  ...
  const FEATURES = [
    "pricing.card.f1", // Harga transparan
    "pricing.card.f2", // Kualitas terjamin
    "pricing.card.f3", // Konsultasi gratis
  ];
      ...
      <div className="container mx-auto">
        ...
        <motion.div
          className="relative max-w-5xl mx-auto rounded-3xl overflow-hidden p-8 md:p-12
                     border border-white/10 bg-gradient-to-b from-white/10 via-white/5 to-transparent
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <ul className="space-y-3 mb-8">
                {FEATURES.map((featureKey) => (
                  <li
                    key={featureKey}
                    className="flex items-center justify-center md:justify-start gap-3 text-white/80"
                  >
              ...
              <button
                ...
                onClick={() => {
                  const el = document.querySelector("#colla borate");
